...
int main(){
    Observation obs_array[] = {
        //Two observations for 2023-06-10 at station 7
        { {2023, 6, 10}, 1, 11, 7, 1 },
        { {2023, 6, 10}, 1, 16, 7, 2 },
        //Two observations for 2023-06-10 at station 9
        { {2023, 6, 10}, 13, 21, 9, 10 },
        { {2023, 6, 10}, 13, 26, 9, 20 },

        //Two observations for 2018-03-04 at station 1
        { {2018, 3, 4}, 15, 12, 1, 15 },
        { {2018, 3, 4}, 19, 13, 1, 25 },

        //Two observations for 2022-09-07 at station 1
        { {2022, 9, 7}, 18, 7, 1, 9 },
        { {2022, 9, 7}, 11, 1, 1, 12 },
